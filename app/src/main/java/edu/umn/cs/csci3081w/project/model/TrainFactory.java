...
public class TrainFactory implements VehicleFactory {
  ...
  public Vehicle generateVehicle(Line line) {
    ...
    if (typeOfVehicle != null && typeOfVehicle.equals(ElectricTrain.ELECTRIC_TRAIN_VEHICLE)) {
      ...
      generatedVehicle = new GreenDecorator(generatedVehicle);
      ...
      generatedVehicle = new YellowDecorator(generatedVehicle);
      generatedVehicle = new AlphaDecorator(generatedVehicle);
  ...
  public void returnVehicle(Vehicle vehicle) {
    if (vehicle.getVehicleType().equals(ElectricTrain.ELECTRIC_TRAIN_VEHICLE)) {
      storageFacility.incrementElectricTrainsNum();
    } else if (vehicle.getVehicleType().equals(DieselTrain.DIESEL_TRAIN_VEHICLE)) {
