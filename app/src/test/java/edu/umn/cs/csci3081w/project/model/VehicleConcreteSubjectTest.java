...
public class VehicleConcreteSubjectTest {
  ...
  public void testNotifyObservers() {
    WebServerSession mockTest = mock(WebServerSession.class);
    VehicleConcreteSubject vehicleConcreteSubject = new VehicleConcreteSubject(
        mockTest);
    vehicleConcreteSubject.attachObserver(testVehicle);
    testVehicle.update();
    vehicleConcreteSubject.notifyObservers();
    ArgumentCaptor<JsonObject> messageCaptor = ArgumentCaptor.forClass(JsonObject.class);
    verify(mockTest).sendJson(messageCaptor.capture());
